          ...
          <div className="row align-items-end">
            <div className="col-lg-12 col-md-12">
              <div className="appie-section-title">
                ...
                <p>
                  {logo
                    ? logo.map((x) => <span>{x.attributes.para}</span>)
                    : "hgfhgf"}{" "}
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t1}</span>)
                    : "hgfhgf"}
                </h4>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t2}</span>)
                    : "hgfhgf"}
                </h4>
                {/* <p>He lost his bottle loo don't get shirty with me ruddy.</p> */}
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t3}</span>)
                    : "hgfhgf"}
                </h4>
                {/* <p>He lost his bottle loo don't get shirty with me ruddy.</p> */}
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t4}</span>)
                    : "hgfhgf"}
                </h4>
                {/* <p>He lost his bottle loo don't get shirty with me ruddy.</p> */}
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t5}</span>)
                    : "hgfhgf"}
                </h4>
                {/* <p>He lost his bottle loo don't get shirty with me ruddy.</p> */}
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="title">
                  {logo
                    ? logo.map((x) => <span>{x.attributes.t6}</span>)
                    : "hgfhgf"}
                </h4>
                {/* <p>He lost his bottle loo don't get shirty with me ruddy.</p> */}
              </div>
